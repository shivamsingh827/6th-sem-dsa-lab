...
int main()
{
    ...
    if (direction == -1)
    {
        ...
        cout << "Head moves from-->" << currHead << " to "
             << " 0" << endl;

        totalHeadMovement += currHead;
        currHead = 0;
    ...
    else
    {
        ...
        cout << "Head moves from-->" << currHead << " to " << memorySize - 1 << endl;
        totalHeadMovement += (memorySize - 1 - currHead);

        currHead = memorySize - 1;
